...
export default function BookingPortal() {
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 w-full overflow-x-hidden">
      ...
      {/* 2. BARRA DE OFERTAS (Getaway Deal Australia) */}
      <div className="bg-amber-50 border-b border-amber-200 py-3 w-full">
        <div className="max-w-7xl mx-auto px-4 text-center text-sm font-medium text-amber-900">
           <a 
             ...
             target="_blank" 
             rel="noopener sponsored" 
             className="hover:underline inline-flex flex-wrap justify-center items-center gap-2"
           >
      ...
      <section className="relative w-full bg-blue-900 text-white py-20 px-4">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg text-slate-200">
            Compara millones de hoteles y apartamentos con cancelación gratuita.
          </p>
          <div className="mt-8">
            <a 
              href="https://www.tkqlhce.com/click-101825316-14398479" 
              target="_blank" 
              rel="noopener sponsored"
              className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-3 rounded-lg shadow-lg transition"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              ...
              <a href="https://www.tkqlhce.com/click-101825316-17314768" target="_blank" rel="noopener sponsored" className="group block w-full">
                <div className="h-64 rounded-xl relative overflow-hidden shadow-md bg-slate-900 flex items-end p-4 border border-slate-200">
                  <img src="https://www.tqlkg.com/image-101825316-17314768" alt="Booking Australia" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition duration-500 opacity-90" />
                  <div className="relative z-10 bg-white/95 px-3 py-1.5 rounded shadow text-blue-900 font-bold text-sm">
          ...
          <aside className="w-full lg:w-80 flex flex-col gap-6 flex-shrink-0">
            ...
            <div className="bg-blue-900 text-white p-6 rounded-xl shadow-md text-center space-y-4 w-full">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener sponsored"
                className="inline-block bg-yellow-400 hover:bg-yellow-500 text-blue-950 font-bold px-4 py-3 rounded-lg text-sm transition w-full shadow"
              >
