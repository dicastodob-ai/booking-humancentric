...
export default function BookingPortal() {
  // Matriz de destinos con fotos reales en alta definición y tus enlaces de CJ Affiliate
  const destinations = [
  ...
  // Duplicamos dinámicamente para rellenar la cuadrícula de 30 productos para la demostración
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      {/* CUADRÍCULA DE 30 PRODUCTOS CON FOTOS REALES */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((item) => (
            <a key={item.id} href={item.url} target="_blank" rel="noopener sponsored" className="group flex flex-col bg-slate-900 rounded-xl border border-slate-200 shadow-sm hover:shadow-lg transition overflow-hidden relative h-64">
              ...
              {/* Contenedor del Título y Etiqueta (Encima de la foto) */}
