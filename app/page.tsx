...
export default function BookingPortal() {
  return (
    <div className="w-full font-sans text-slate-900 bg-slate-50">
      ...
      {/* 2. BARRA DE OFERTAS (Getaway Deal) */}
      ...
      {/* 4. MAIN CONTENT (Sin elementos problemáticos) */}
        ...
        <div className="flex-1 w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            ...
            <a href="https://www.tkqlhce.com/click-101825316-14398479" target="_blank" rel="noopener sponsored" className="group block w-full h-64 rounded-xl relative overflow-hidden shadow-md bg-slate-900 flex items-end p-4 border border-slate-200">
              ...
              <div className="relative z-10 bg-white/95 px-3 py-1.5 rounded shadow text-blue-900 font-bold text-sm">Roma, Italia (Top 1)</div>
            </a>

            {/* LONDRES */}
            <a href="https://www.tkqlhce.com/click-101825316-14398479" target="_blank" rel="noopener sponsored" className="group block w-full h-64 rounded-xl relative overflow-hidden shadow-md bg-slate-900 flex items-end p-4 border border-slate-200">
              <img src="https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=800&q=80" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition duration-500 opacity-80" alt="Londres UK" />
              <div className="relative z-10 bg-white/95 px-3 py-1.5 rounded shadow text-blue-900 font-bold text-sm">Londres, Reino Unido (Top 2)</div>
            </a>

            {/* ESCAPADAS */}
            <a href="https://www.dpbolvw.net/click-101825316-17301956" target="_blank" rel="noopener sponsored" className="group block w-full h-64 rounded-xl relative overflow-hidden shadow-md bg-slate-900 flex items-end p-4 border border-slate-200">
              <img src="https://images.unsplash.com/photo-1488646953014-85cb44e25828?auto=format&fit=crop&w=800&q=80" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition duration-500 opacity-80" alt="Escapadas" />
